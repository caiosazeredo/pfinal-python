...
def loading():
    ...
    diretorio = r"C:\Users\62129532024.1\Downloads\pfinal-python-main (1)\pfinal-python-main\resultadoIA"
    ...
    return render_template('loading.html', arquivo=nome_cadastro)
